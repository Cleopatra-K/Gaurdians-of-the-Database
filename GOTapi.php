...
class ProductAPI {
    ...
    //! the following functions are all functions related to handling the requests
    ...
    */ 
    ...
    public function addFavorite(int $userId, int $tyreId){
    ...
    public function removeFavorites(int $userId, int $tyreId){
