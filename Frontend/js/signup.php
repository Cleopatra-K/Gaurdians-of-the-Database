...
<head>
    ...
    <style>
        /* Add this to your login.css or directly in a <style> tag */
        .hidden {
            display: none;
        }
    </style>
    ...
    <div class="welcome container">
        ...
        <div id="form-container">
            <form id="login-form" class="hidden" onsubmit="return false;">
                <h2>Login</h2>
                <input type="text" id="login-username" name="login-username" placeholder="Username" required>                <input type="password" id="login-password" name="login-password" placeholder="Password" required>
