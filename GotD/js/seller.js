document.addEventListener('DOMContentLoaded', function() {
    ...
    function saveProduct() {
        ...
        const productData = {
            tyre_id: document.getElementById('tyre_id').value,
    ...
    // In your JavaScript file (e.g., admin.js or seller.js if this is an admin function)
...
function deleteProduct(productId) {
    ...
    const requestData = {
        ...
        product_data: {  // This is the required field
            tyre_id: productId,
            // Include other minimal required fields if needed by your API
              "size": '',
  "load_index": 0,
  "has_tube": 0,
  "serial_num": 0,
